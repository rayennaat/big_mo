    ...
    <>
      <section className="relative min-h-[520px] overflow-hidden bg-moBlack pt-20 text-white">
        ...
        <div className="relative mx-auto flex min-h-[440px] max-w-7xl items-end px-5 pb-16 lg:px-8">
          <Reveal variant="up">
            <p className="text-xs font-black uppercase tracking-[.3em] text-moYellow">{language === "fr" ? "Choisis ton envie" : "Pick your craving"}</p>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-white/70">{language === "fr" ? "Burgers signature, poulet croustillant, accompagnements genereux et shakes bien froids." : "Signature burgers, crispy chicken, loaded sides and cold shakes."}</p>
          </Reveal>
        </div>
