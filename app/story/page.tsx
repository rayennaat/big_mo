    ...
    <>
      <section className="relative min-h-[680px] overflow-hidden bg-moBlack pt-20 text-white">
        ...
        <div className="relative mx-auto flex min-h-[600px] max-w-7xl items-end px-5 pb-16 lg:px-8">
          <div className="max-w-4xl">
            <p className="text-xs font-black uppercase tracking-[.3em] text-moYellow">How the shack got loud</p>
            <h1 className="mt-4 font-display text-6xl uppercase leading-[.82] sm:text-8xl lg:text-[9rem]">The BIG MO <span className="text-moRed neon-text">story</span></h1>
          </div>
        </div>
      ...
      <section className="bg-moCream px-5 py-24 lg:px-8 lg:py-32">
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="text-xs font-black uppercase tracking-[.3em] text-moRed">Start with a craving</p>
            <h2 className="mt-4 font-display text-5xl uppercase leading-[.92] sm:text-7xl">Simple food. Serious personality.</h2>
            <p className="mt-7 text-lg leading-8 text-black/65">This page contains brand-story placeholder copy designed around the visual identity in the restaurant photos. Replace it with the real founding story, the people behind BIG MO and what makes the restaurant different.</p>
            <p className="mt-5 text-lg leading-8 text-black/65">The direction is intentional: nostalgic diner materials, bold modern typography and the same red, cream, black and yellow palette found inside the space.</p>
          </div>
          <div className="relative aspect-[4/5] overflow-hidden rounded-[2.5rem] border-4 border-moBlack shadow-card">
            <Image src="/images/guest.jpg" alt="Guest enjoying a meal at BIG MO" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-moBlack px-5 py-24 text-white lg:px-8 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <p className="text-xs font-black uppercase tracking-[.3em] text-moYellow">What BIG MO stands for</p>
