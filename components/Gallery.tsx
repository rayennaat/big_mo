      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid auto-rows-[260px] gap-4 md:grid-cols-4 md:auto-rows-[240px]">
          {images.map((image, index) => (
            <Reveal key={image.src + image.alt} delay={index * 100} variant="zoom" className={image.span}>
              <div className="group relative h-full overflow-hidden rounded-[2rem] border-2 border-moBlack">
